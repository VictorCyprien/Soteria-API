...
@soteria_web.view('/characters/{character_id}/equipement/armor/{armor_id}/store')
class ArmorVaultStoreView(EquipementAbstractView):
    @property
    ...
    @docs(
        summary="Store Armor",
        description="Store a armor to the vault",
        responses={
    ...
    async def post(self) -> web.Response:
        ...
        armor_stored = await self.store_weapon_to_vault(
            access_token,
            armor_id,
            character_equipment,
            character_id,
        ...
        if not armor_stored:
            raise HTTPNotFound(text="The armor is not on this character or is equiped")
